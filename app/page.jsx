  ...
  return (
    <main id="top" className={loaded ? "site loaded" : "site"}>
      ...
      <section ref={heroRef} className="hero" aria-labelledby="hero-title">
        ...
        <div className="hero-3d" aria-label="Interactive 3D NovaFrame scene">
          <spline-viewer url="https://prod.spline.design/9951u9cumiw2EhJ8/scene.splinecode" loading-anim-type="spinner-small-dark" events-target="global" />
          <div className="hero-3d-shade" aria-hidden="true" />
          <div className="floating-label">INTERACTIVE 3D<br /><strong>DRAG / MOVE</strong></div>
        </div>
        <div className="hero-cursor-note" aria-hidden="true">MOVE YOUR CURSOR · EXPLORE THE FRAME</div>
      ...
      <section className="intro section" aria-labelledby="intro-title">
        ...
        <div className="intro-bottom"><p>From the first sketch to the final frame, NovaFrame combines design, animation, 3D, interaction and storytelling to create work with a pulse.</p><div className="stat"><strong>40+</strong><span>stories brought<br />to life</span></div><div className="stat"><strong>12</strong><span>creative<br />disciplines</span></div></div>
      </section>

      <section id="work" className="work section" aria-labelledby="work-title">
        <div className="section-head"><div><p className="eyebrow">Selected work</p><h2 id="work-title">Made to <em>move.</em></h2></div><a href="#contact" className="text-link">Start a new project ↗</a></div>
        <div className="project-grid">
          <article className="project project-1"><div className="project-media project-video"><iframe src="https://player.vimeo.com/video/733560561?background=1&autoplay=1&loop=1&muted=1&title=0&byline=0&portrait=0" title="Abstract 3D animation preview" loading="lazy" allow="autoplay; fullscreen; picture-in-picture" /></div><div className="project-info"><h3>{projects[0][0]}</h3><p>{projects[0][2]}</p><span>{projects[0][1]} · Interactive scene ↗</span></div></article>
          <article className="project project-2"><div className="project-media project-2d" aria-label="Animated 2D motion graphic preview"><div className="shape-orbit"><i /><i /><i /><b>2D</b></div><div className="kinetic-word">MOVE</div><span className="project-number">02</span><span className="project-type">2D / MOTION</span></div><div className="project-info"><h3>{projects[1][0]}</h3><p>{projects[1][2]}</p><span>Interactive 2D system ↗</span></div></article>
          <article className="project project-3"><div className="project-media project-spline-mini"><spline-viewer url="https://prod.spline.design/9951u9cumiw2EhJ8/scene.splinecode" /><span className="project-number">03</span><span className="project-type">3D / PRODUCT</span></div><div className="project-info"><h3>{projects[2][0]}</h3><p>{projects[2][2]}</p><span>Material study · 3D ↗</span></div></article>
          <article className="project project-4"><div className="project-media project-2d character-stage"><div className="character"><div className="eye eye-a" /><div className="eye eye-b" /><div className="smile" /></div><div className="character-orb" /><span className="project-number">04</span><span className="project-type">CHARACTER / 2D</span></div><div className="project-info"><h3>{projects[3][0]}</h3><p>{projects[3][2]}</p><span>Character animation study ↗</span></div></article>
        </div>
      </section>

      <section className="showreel section" aria-labelledby="showreel-title">
        <div className="showreel-copy"><p className="eyebrow">Motion reference</p><h2 id="showreel-title">Real movement.<br /><em>Real texture.</em></h2><p>Explore animation in motion instead of static mockups. The site uses immersive 3D, animated 2D compositions and hosted motion references to make the studio feel like a working creative space.</p></div>
        <div className="showreel-frame"><iframe src="https://player.vimeo.com/video/1131407948?background=1&autoplay=1&loop=1&muted=1&title=0&byline=0&portrait=0" title="2D animation showreel reference" loading="lazy" allow="autoplay; fullscreen; picture-in-picture" /></div>
      </section>
