...
export default function Home() {
  ...
  return (
    <main id="top" className={loaded ? "site loaded" : "site"}>
      ...
      <section id="services" className="services section" aria-labelledby="services-title"><div className="section-head"><div><p className="eyebrow">Capabilities</p><h2 id="services-title">Our creative<br /><em>toolkit.</em></h2></div><a href="/services" className="text-link">Explore services ↗</a></div><div className="service-list">{services.map(s => <article className="service" key={s[0]}><span>{s[0]}</span><h3>{s[1]}</h3><p>{s[2]}</p><b aria-hidden="true">↗</b></article>)}</div></section>
